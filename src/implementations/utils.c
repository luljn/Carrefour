...
void genererVehicules(Vehicule *vehicules[]){
    ...
    for(int i = 0; i<=9; i++){
        ...
        if(i%2 == 0 && i%3 != 0)
            *vehicules[i] = initialiserVehicule(compteurVehicule, "ambulance", 40.0, "Carrefour 1");
        else if(i%3 == 0 && i%2 != 0)
            *vehicules[i] = initialiserVehicule(compteurVehicule, "camion de pompiers", 50.0, "Carrefour 1");
        else if(i%2 == 0 && i%3 == 0)
            *vehicules[i] = initialiserVehicule(compteurVehicule, "police", 35.0, "Carrefour 1");
        else
            *vehicules[i] = initialiserVehicule(compteurVehicule, "voiture", 30.0, "Carrefour 1");
    }
}